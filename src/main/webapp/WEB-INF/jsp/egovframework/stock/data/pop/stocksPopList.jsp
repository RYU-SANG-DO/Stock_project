...
function linkPage(pageNo){
	...
	document.stockFrm.action = "<c:url value='/stock/data/selectStocksPopList.do'/>";
...
<body>
<form name="stockFrm" action ="<c:url value='/stock/data/selectStocksPopList.do'/>" method="post">
