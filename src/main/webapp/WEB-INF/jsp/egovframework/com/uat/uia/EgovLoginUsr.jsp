		...
		<div class="login_input">
			<ul>
				...
				<li>
					...
					<input type="text" name="id" id="id" maxlength="20" title="${title} ${inputTxt}" placeholder="${title} ${inputTxt}" value="USER">
				</li>
				<!-- 비밀번호 -->
		...
		<div class="login_input" style="display: none">
			<ul>
				<li>
					...
					<input type="password" name="pwd" id="" maxlength="20" title="${title} ${inputTxt}" placeholder="<spring:message code="comUatUia.loginForm.pw"/>" value="rhdxhd12"><!-- 비밀번호 -->
				</li>
				<li>
