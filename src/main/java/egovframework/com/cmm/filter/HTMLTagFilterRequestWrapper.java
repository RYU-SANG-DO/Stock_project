...
public class HTMLTagFilterRequestWrapper extends HttpServletRequestWrapper {
	...
	public String[] getParameterValues(String parameter) {
		...
		String[] values = super.getParameterValues(parameter);
		 ...
		 if (customParams.containsKey(parameter)) {
	            return customParams.get(parameter);
	        }
	...
	public String getParameter(String parameter) {
		...
		String value = super.getParameter(parameter);
		 ...
		 if (customParams.containsKey(parameter)) {
	            return customParams.get(parameter)[0];
	        }
...
//    	Map<String, String[]> valueMap = super.getParameterMap();
    	Map<String, String[]> valueMap = new HashMap<>(super.getParameterMap());
    	if (customParams != null) {
    		valueMap.putAll(customParams);
    	}
...
//            System.out.println( String.format("키 : %s, 값 : %s", key, Arrays.toString(valueMap.get(key))) );
        }
