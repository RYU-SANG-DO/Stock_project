...
public class EgovWebApplicationInitializer implements WebApplicationInitializer {
	...
	private static final String CONFIG_LOCATION = "/WEB-INF/config/egovframework/springmvc/egov-com-*.xml";
	@Override
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		// Spring ServletContextListener 설정
		//-------------------------------------------------------------
		LOGGER.info("/WEB-INF/config/egovframework/springmvc/egov-com-*.xml START-============================================");
...
//		dispatcher.setInitParameter("contextConfigLocation", CONFIG_LOCATION);
		LOGGER.info("/WEB-INF/config/egovframework/springmvc/egov-com-*.xml END-============================================");
